...
socket.on('newRound', function(newRound) {
	...
	$("#roundsContainer").append(
		"<div class='row'><div class='col-md-3'>"+currentRound+"</div><div class='col-md-3'>" +
		""+newRound.x+ "&nbsp;"+newRound.operation+"&nbsp"+newRound.y+	"</div><div class='col-md-3'><input type='text'" +
		" id='round"+currentRound+"' style='width:50px;'/>&nbsp;<input type='button' id='btnSubmit' value='Submit'/> " +
		"</div><div class='col-md-3' id='divResult"+currentRound+"'></div></div>"
	);
});
